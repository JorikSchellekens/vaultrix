 ...
 * in environments where they're missing. Must run before any @vaultrix/core (matrix) code.
 */
  ...
  typeof globalThis !== "undefined"
    ...
    : typeof self !== "undefined"
      ...
      : typeof window !== "undefined"
        ? (window as Window & { btoa?: (s: string) => string; atob?: (s: string) => string })
        : ({} as Window & { btoa?: (s: string) => string; atob?: (s: string) => string });
